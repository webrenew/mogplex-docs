...
description: Umbrella skill for guiding a user through the Mogplex CLI cockpit when no Mogplex MCP server is available.
---
...
If it's missing, point the user at [Installation](https://www.mogplex.com/cli/installation).
