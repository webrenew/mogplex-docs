...
<Cards>
  ...
  <Card title="Skills" href="/cli/skills" description="Agent Skills that guide users through the Mogplex cockpit — slash commands, login flow, and repo-local config." />
</Cards>
