...
It can override the mode and add `allow` / `deny` / `ask` rules that are layered **on top of** the global rules. Projects can be more permissive than the global file.
