...
3. `GET /api/github/installations` to confirm App coverage
4. `GET /api/mcp-servers?format=cli` if the CLI should mirror hosted tools
5. `GET /api/observability/stats` once work is actually running
